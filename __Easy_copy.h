#ifndef __EASY_COPY_H
#define __EASY_COPY_H
...
{
#ifdef test
	cout << "__copy_t without the trivial assignment operator" << endl;
#endif
...
{
#ifdef test
	cout << "__copy_t with the trivial assignment operator" << endl;
#endif
...
{
#ifdef test
	cout << "__copy random_access_iterator_tag" << endl;
#endif
...
{
#ifdef test
	cout << "Completely generalization copy" << endl;
#endif
